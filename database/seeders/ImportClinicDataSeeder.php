...
class ImportClinicDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            [
                ...
                'password' => '$2y$12$akTZjdjVv618a8QdvipFrO6NqNrlOnd2/RfuAPbV./tnT/gSfwsx2',
                'role_id' => 1,
            ],
            [
                'id' => 3,
                'name' => 'Dave',
                'username' => 'dave',
                'email' => 'dave@clinic.test',
                'password' => '$2y$12$xb5v.Q4hr55e6AtzQdq1jugRACIFTaJlszP7quOlZCyc43xN1ryNq',
                'role_id' => 1,
            ],
            [
                'id' => 4,
                'name' => 'Ace',
                'username' => 'ace',
                'email' => 'ace@clinic.test',
                'password' => '$2y$12$xhkAlOt8zUYtchbkt54Ay.ZWthwq6Xy8/u/ayfDNvO1bT7LDAr7NO',
                'role_id' => 2,
            ],
            [
                'id' => 6,
                'name' => 'Galor',
                'username' => 'galor',
                'email' => 'galor@clinic.test',
                'password' => '$2y$12$HCjPadL1qtjVnPV0Yt0aturcFjycaU.ym6/jLa9tuqsAq05RE5Ovy',
                'role_id' => 2,
            ],
        ]);
        ...
        DB::table('patients')->insert([
            ...
            [
                ...
                'first_name' => 'RENZ',
                'mobile_number' => '67',
                'middle_name' => 'SALUMBIDES',
                'home_address' => '2107 Rosal Street, Batasan Hills Quezon City',
                'modified_by' => 'SYSTEM',
            ],
            [
                'id' => 25,
                'last_name' => 'ROSALES',
                'first_name' => 'CLARENZ LUIGI',
                'mobile_number' => '092259951316',
                'middle_name' => 'SALUMBIDES',
            ...
            [
                ...
                'gender' => 'Male',
                'civil_status' => 'SINGLE',
                'home_address' => '2107 ROSAL STREET',
                'emergency_contact_name' => 'LAARA ROSALES',
                'emergency_contact_number' => '0997',
        ...
        echo "All clinic data imported successfully!\n";
    }
}
